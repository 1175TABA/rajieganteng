...
const loadAdditionalFont = (c) => {
    ...
    const fonts = [
        { css: 'https://fonts.googleapis.com/css2?family=Great+Vibes&display=swap', family: 'Great Vibes' },
        { css: 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@600&display=swap', family: 'Cormorant Garamond' },
